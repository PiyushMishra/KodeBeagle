...
object Dependencies {
  ...
  val esSpark = ("org.elasticsearch" % "elasticsearch-spark_2.11" % "2.2.0-m1").exclude("org.apache.spark", "spark-sql_2.11").exclude("org.apache.spark", "spark-core_2.11")
  ...
  val kodebeagle = Seq(junit, es, scalastyle, spark, parserCombinator, scalaTest, slf4j, javaparser,
